    ...
    try:
        async with async_playwright() as p:
            ...
            try:
                ...
                # 🟢 GIẢ LẬP GÕ BÀN PHÍM: Gõ từng ký tự chậm rãi (delay 80-150ms)
                await page.type(".gsc-input input", query, delay=random.randint(80, 150))
                
                search_clicked = False
                try:
                    # 🟢 NGHỈ NGẪU NHIÊN 2-4 GIÂY TRƯỚC KHI BẤM NÚT SEARCH
            ...
            # 🟢 Đợi kết quả load, cộng thêm một ít ngẫu nhiên
